...
export interface HeaderProps {
  ...
  /** Whether to show authentication links */
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="md:hidden">
            <button
              ...
              aria-label={isMobileMenuOpen ? NAVIGATION_LABELS.CLOSE_MENU : NAVIGATION_LABELS.MENU}
            >
              {isMobileMenuOpen ? (
                <X className="h-6 w-6 rotate-90 transition-transform duration-300" aria-hidden="true" />
              ) : (
